...
const surface=refs.at(-1)?.anchor.scope==='cover'||new URLSearchParams(location.search).get('surface')==='cover'?'cover':'quiz';frame.src=`share.html?embedded=1&surface=${window.fileFormat==='html'?surface:'cover'}&format=${window.fileFormat}&v=28`;
